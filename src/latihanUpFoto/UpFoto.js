...
export default class UpFoto extends React.Component{
    constructor() {
        super();
        this.state = {
          image: '',
        ...
        UpFoto(){
          this.uploadPicture();
          axios.post("https://perpustakaan1095.000webhostapp.com/TambahFoto.php", {
        ...
        uploadPicture = () => {
          ...
          const url =
            "https://perpustakaan1095.000webhostapp.com/UpFoto.php";
          fetch(url, {
            method: "post",
            body: data
          })
